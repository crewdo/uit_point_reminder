...
class StudentsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ...
            ->notEmpty('student_password');

        $validator
            ->scalar('student_email')
            ->allowEmpty('student_email');

        $validator
            ->scalar('student_phone_number')
            ->allowEmpty('student_phone_number');

        $validator
            ->scalar('student_html_point')
            ->allowEmpty('student_html_point');
